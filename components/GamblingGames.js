...
export default function GamblingGames() {
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity style={[styles.button, styles.plinkoButton]}>
        <Text style={styles.buttonText}>🍕 Plinko</Text>
      </TouchableOpacity>
      <TouchableOpacity style={[styles.button, styles.slotsButton]}>
        <Text style={styles.buttonText}>🍒 Slots</Text>
      </TouchableOpacity>
      <TouchableOpacity style={[styles.button, styles.pokerButton]}>
